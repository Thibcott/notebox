...
Ce projet a été généré, debuggué, et enrichi **intégralement par l'IA Antigravity (Google)**, sans intervention manuelle sur le code. Dans le but de tester et d’explorer les limites de l’IA. 
